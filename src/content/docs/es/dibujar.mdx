...
Las pantallas pueden encontrarse en muchas resoluciones: 800X600, 1024X768, 1280X1024, etc, etc.
...
El parámetro radio corresponde al radio de redondeo. La versión con otros cuatro parámetros permite agregar un radio distinto de redondeo a cada esquina. Siendo si (Superior Izquierdo), sa (Superior Derecho), id (Inferior Derecho) y ii (Inferior Izquierdo).
...
parámetro que puede ser CORNER, CORNERS o CENTER. El modo por defecto es CORNER que funciona como fue explicado en el apartado de la función rect().
