...
Usando la metáfora de sketch (bosquejo), `p5.js` tiene un conjunto completo de funcionalidades para dibujar. Sin embargo, no estás limitado solo a dibujar en tu lienzo. Podés tomar toda la página del navegador como tu sketch, incluyendo los objetos HTML5 para texto, entrada, video, cámara web y sonido.
